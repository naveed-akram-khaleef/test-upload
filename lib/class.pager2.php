   ...
   ***********************************************************************************/ 
   function nextPrev($curpage, $pages, $qryString) 
    { 
     ...
     if (($curpage-1) <= 0) 
      { 
       $next_prev .= "<li><span>".Previous."</span></li>"; 
      } 
     else 
      { 
       $next_prev .= "<li class='active'><a href=\"".$_SERVER['PHP_SELF']."?page=".($curpage-1).$qryString."\">".Previous."</a>"; 
      } 
	/*	
	for ($i=1; $i<=$pages; $i++) 
      { 
	...
	*/
     if (($curpage+1) > $pages) 
      { 
       $next_prev .= "<li><span>".Next."</span></li>";
      } 
     else 
      { 
       $next_prev .= "<li class='active'><a href=\"".$_SERVER['PHP_SELF']."?page=".($curpage+1).$qryString."\">".Next."</a></li>"; 
      } 
