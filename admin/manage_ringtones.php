...
if(isset($_REQUEST['action'])){
	if(isset($_REQUEST['btnEdit'])){
		...
		header("Location: manage_ringtones.php?op=1&hddn=".$hddn);
	}
			...
			<div id="main_section" class="cf brdrrad_a">
				...
				<div id="content_wrapper">
					<div id="main_content" class="cf">
                        ...
                        <?php }?>
                        <div class="sepH_c">
                            <h1 class="sepH_c">Ringtones Management</h1>
							<?php
                            ...
                            ?>
                                <div class="formEl_a">
                                    <fieldset class="sepH_b">
                                        ...
                                        ?>
                                                ...
                                                <?php
                                                    $counter=0;
                                                    $Query = "SELECT pt.*, prf.* FROM pr_types AS pt LEFT OUTER JOIN pr_files AS prf ON pt.ptype_id=prf.ptype_id WHERE pt.cat_id=3 AND prf.pr_id=".$row->pr_id." ";
                               ...
                               <input type="button" name="btnCancel" class="submitButton" value="BACK" onClick="javascript: window.location= 'manage_ringtones.php';">  
                            <?php	
                                        ...
                                        <fieldset class="sepH_b">
                                            ...
                                            ?>
                                                    <div class="sepH_b">
                                                        ...
                                                        <select name="cat_id">
                                                            <?php echo FillSelected2("categories AS c LEFT OUTER JOIN categories_ln AS cl ON c.cat_id=cl.cat_id ", "c.cat_id", "cl.cat_name", $cat_id, " c.cat_parentid=3 AND cl.lang_id=".$_SESSION['lang_id']." ");?>
                                                        </select>
                                                    </div>
                                            <?php		
												if(isset($_REQUEST['pr_id'])){
													$Query = "SELECT DISTINCT pt.*, prf.prf_thumb, prf.prf_file, prf.prf_preview FROM pr_types AS pt LEFT OUTER JOIN pr_files AS prf ON pt.ptype_id=prf.ptype_id WHERE pt.cat_id=3 AND prf.pr_id=".$_REQUEST['pr_id']." ";
												} else {
													$Query = "SELECT DISTINCT pt.* FROM pr_types AS pt WHERE pt.cat_id=3 ";
												}
                                                $counter=0;
                                                $count = mysql_num_rows(mysql_query($Query)); 
                                                $rs = mysql_query($Query);
...
<!--                                                  <label for="a_text" class="lbl_a">Format <?php echo @$counter?>:</label>-->
                                        ...
                                        ?>
                                        <input type="button" name="btnCancel" value="BACK" class="submitButton" onClick="javascript: window.location= 'manage_ringtones.php';">
                                    </div>
                                </form>
                            <?php } else{ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<?php 
                                                        ...
                                                        $total_vots = 0;
                                                        $avg = 0.0;
                                                        $qry1 = mysql_query("SELECT COUNT( 1 ) AS total_records, SUM( rate ) AS total FROM votes WHERE section_id=3 AND pro_id=".$row->pr_id);
                                                        if( mysql_num_rows($qry1)>0 ){
                                                            $row1 = mysql_fetch_object($qry1);
                                                            $total_ratings = $row1->total;
                                                            $total_vots = $row1->total_records;
                                                ...
                                                <!--<td align="center"><a href="manage_ringtones.php?action=3&pr_id=<?php echo $row->pr_id;?>"> Add </a></td>-->
