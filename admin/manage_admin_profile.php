...
if(isset($_REQUEST['btnEdit'])){
	mysql_query("UPDATE user SET user_name='".$_REQUEST['name']."', user_password='".md5($_REQUEST['pass'])."' WHERE user_id='".$_SESSION['UID']."' ");
	header("Location: manage_admin_profile.php?op=1");
}

$rs = mysql_query("SELECT * FROM user WHERE user_id=".$_SESSION['UID']);
                                    ...
                                    <div class="cf formEl sepH_b">
                                        ...
                                        <div class="dp75">
                                            <div class="sepH_b">
                                                ...
                                                <input type="text" class="inpt_a" id="username" name="name" value="<?php echo $name;?>"/>
                                            </div>
                                            <div class="sepH_b">
                                                <label for="fname" class="lbl_a">Password</label>
                                                <input type="password" class="inpt_a" id="fname" name="pass" value="<?php echo $pass;?>" />
                                            </div>
