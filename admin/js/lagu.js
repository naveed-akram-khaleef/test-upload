...
lga_editor = {
	init: function() {
		$('textarea.tinymce').tinymce({
			...
			theme : "advanced",
			plugins : "autolink,lists,pagebreak,style,table,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,pVote,media,searchreplace,print,contextmenu,paste,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,advlist",
...
lga_editor_default = {
	init: function() {
		$('textarea.tinymce').tinymce({
			script_url : 'lib/tiny-mce/tiny_mce.js',
			theme : "advanced",
			plugins : "autolink,lists,pagebreak,style,table,advimage,advlink,emotions,inlinepopups,pVote,media,print,contextmenu,paste,advlist",
			theme_advanced_toolbar_location : "top",
			theme_advanced_toolbar_align : "left",
			theme_advanced_statusbar_location : "bottom",
			theme_advanced_resizing: true,
