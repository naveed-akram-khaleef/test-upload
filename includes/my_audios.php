...
<div class="table">
  <div class="head">
	...
	<?php
    $Query = " SELECT mc.*, pr.* FROM my_collection AS mc LEFT OUTER JOIN products AS pr ON mc.pr_id=pr.pr_id WHERE mc.mem_id=".$_SESSION["memID"]." AND mc.cat_id=1 ORDER BY mc.mc_id DESC";
    $counter=0;
    $limit = 25;
