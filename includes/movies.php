                                ...
                                <div class="float_left">
                                    <?php if($preview_file!=''){?>
										<?php if($_SESSION['isIPhone']==1){?>
                                            <a href="http://178.79.149.95/vod/videos/preview/<?php echo $p_file_ext;?>:<?php echo $p_file_name;?>/playlist.m3u8" title="<?php echo Preview;?>" target="_blank" id="clk"><img src="images/icons/full_view_icon.png"/></a>
                                        <?php } else { ?>
